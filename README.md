...
* **[p-map](https://github.com/sindresorhus/p-map) ⭐ 1,512 | 🐛 12 | 🌐 JavaScript | 📅 2026-09-18**: Map over promises concurrently
...
* **[p-event](https://github.com/sindresorhus/p-event) ⭐ 450 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-18**: Promisify an event by waiting for it to be emitted
...
* **[make-synchronous](https://github.com/sindresorhus/make-synchronous) ⭐ 332 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-26**: Make an asynchronous function synchronous
...
* **[p-settle](https://github.com/sindresorhus/p-settle) ⭐ 96 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-18**: Settle promises concurrently and get their fulfillment value or rejection reason with optional limited concurrency
* **[p-defer](https://github.com/sindresorhus/p-defer) ⭐ 87 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-18**: Create a deferred promise
* **[p-locate](https://github.com/sindresorhus/p-locate) ⭐ 82 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-18**: Get the first fulfilled promise that satisfies the provided testing function
* **[p-filter](https://github.com/sindresorhus/p-filter) ⭐ 82 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-18**: Filter promises concurrently
* **[p-waterfall](https://github.com/sindresorhus/p-waterfall) ⭐ 79 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-18**: Run promise-returning & async functions in series, each passing its result to the next
...
* **[p-series](https://github.com/sindresorhus/p-series) ⭐ 72 | 🐛 0 | 🌐 JavaScript | 📅 2021-08-12**: Run promise-returning & async functions in series
...
* **[p-reflect](https://github.com/sindresorhus/p-reflect) ⭐ 56 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-18**: Make a promise always fulfill with its actual fulfillment value or rejection reason
