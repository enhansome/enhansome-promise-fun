...
* **[p-mutex](https://github.com/sindresorhus/p-mutex) ⭐ 143 | 🐛 1 | 🌐 JavaScript | 📅 2025-07-06**: Ensure that only one operation accesses a particular resource at a time
* **[p-state](https://github.com/sindresorhus/p-state) ⭐ 134 | 🐛 0 | 🌐 JavaScript | 📅 2025-09-23**: Inspect the state of a promise
