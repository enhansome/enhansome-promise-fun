...
* **[p-queue](https://github.com/sindresorhus/p-queue) ⭐ 4,274 | 🐛 7 | 🌐 TypeScript | 📅 2026-07-22**: Promise queue with concurrency control
...
* **[p-event](https://github.com/sindresorhus/p-event) ⭐ 450 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-14**: Promisify an event by waiting for it to be emitted
